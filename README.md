...
For a more complete example, using all of the functionality provided by the suite package, look at our [example testing suite](https://github.com/ghetzel/testify/blob/master/suite/suite_test.go)
